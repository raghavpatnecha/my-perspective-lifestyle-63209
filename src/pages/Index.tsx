          ...
          <div className="max-w-4xl mx-auto glass-card p-8 md:p-12 animate-slide-up">
            <div className="space-y-6">
              <div className="flex flex-col items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold glow-text text-center">A media space built for thought</h2>
              </div>
        ...
        <section id="vision" className="py-16 md:py-20">
          <div className="max-w-4xl mx-auto glass-card p-8 md:p-12 animate-slide-up stagger-2 glow-border">
            <div className="space-y-6">
              <div className="flex flex-col items-center gap-3 mb-6">
                <div className="h-1 w-12 bg-gradient-to-r from-secondary to-accent rounded-full animate-shimmer"></div>
                <h2 className="text-3xl md:text-4xl font-bold glow-text text-center">Reimagining how the world is understood</h2>
              </div>
              <p className="text-lg text-muted-foreground leading-relaxed text-justify">
        ...
        <section className="my-20 rounded-[2.5rem] glass-card p-12 md:p-16 text-center animate-scale-in glow-border">
          <div className="max-w-3xl mx-auto space-y-8">
            <div className="inline-block animate-float">
              <div className="h-1 w-12 bg-gradient-to-r from-secondary to-accent rounded-full animate-shimmer mx-auto mb-6"></div>
            </div>
